                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            {{-- 1. INGRESSOS --}}
                            <x-dropdown-link href="{{route('inscriptions.index')}}" class="flex items-center gap-3 py-3 group hover:bg-gray-50">
                            ...
                            {{-- Dashboard --}}
                            <x-dropdown-link href="{{route('dashboard')}}" class="flex items-center gap-3 py-3 group hover:bg-gray-50">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
        ...
        <div class="pt-4 pb-1 border-t border-purple-500">
            @auth
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link href="{{route('inscriptions.index')}}" class="text-white hover:bg-purple-600">Ingressos</x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('profile.edit')" class="text-white hover:bg-purple-600">Conta</x-responsive-nav-link>
